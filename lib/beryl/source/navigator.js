  ...
  enyo.kind({
    ...
    components: [
      {name: "applicationHeader", classes: "row", components: [
        ...
        {content: "Search Bar", classes: "col-lg-8 col-md-8", components: [
          {kind: "enyo.Input", name: "searchInput", placeholder: "Search...",
        ...
        { tag: "a", attributes: { href: "https://pangea.zendesk.com/", target: "_blank" }, content: "Help Link", classes: "col-lg-1 col-md-1" }
      ]},
      {name: "applicationActionHolder", classes: "row", components: [
        ...
        {name: "subModuleToolbar", classes: "col-lg-10 col-md-10", components: [
          {classes: 'row', components: [
            ...
            {name: 'rightActionGroup', ontap: 'actionItemSelected', classes: 'col-lg-5 col-md-5 col-lg-offset-1 col-md-offset-1', style: 'text-align: right', defaultKind: 'onyx.Button'},
            {kind: 'onyx.MenuDecorator', classes: 'col-lg-1 col-md-1', onSelect: 'actionItemSelected', components: [
              {kind: "XV.IconButton", src: "/assets/menu-icon-gear.png"},
              {name: 'actionMenu', kind: 'onyx.Menu'}
            ]}
          ]}
        ]}
      ]},
      {name: "applicationContainer", classes: "row", components: [
        // Sidebar
        {name: "sidebar", kind: "Panels", fit: true, classes: "col-lg-2 col-md-2", arrangerKind: "flexboxArranger", components: [
    ...
    */
    buildSubModuleToolbar: function() {
      var panel       = this.$.contentPanels.getActive(),
          ...
          actions     = [
            ...
            {content: 'New', value: 'new', placement: 'menu'},
      ...
      _.chain(actions).compact().each(function (action) {
        var actionPrivilages = action.privilege ? action.privilege.split(" ") : [],
            isDisabled = !_.some(actionPrivilages, function (priv) {
        ...
        switch(action.placement) {
          case 'menu':
            this.$.actionMenu.createComponent({
              name: action.name,
              kind: XV.MenuItem,
    ...
    clearSubModuleToolbar: function() {
      ...
      this.$.actionMenu.destroyClientControls();
    },
    ...
    */
    itemTap: function (inSender, inEvent) {
      ...
      if (workspace) {
        ...
        _.each(module.panels, function(panel, i) {
        ...
        this.setContentPanel(index, { 'id': id });
      }
    ...
    modulePickerChanged: function(inSender, inEvent) {
      ...
      var panels = module.panels ? _.reject(module.panels, function(panel) { return panel.workspace; }) : [],
    ...
    setContentPanel: function (index, options) {
      ...
      if(options) {
        if(options.id === false) {
          ...
          // yuck...  TODO: make this prettier
          panel.$.panels.node.style.height = this.$.contentPanels.node.getClientRects()[0].height + 'px';
        }
      }
      ...
      // }
      if (collection && panel.fetch && !this.fetched[panelIndex]) {
        this.fetch();
      ...
      if(this.$.modulePicker.getSelected().indexInContainer() === 1) {
