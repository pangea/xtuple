  ...
  enyo.kind({
    ...
    components: [
      {name: "applicationHeader", classes: "row", components: [
        ...
        {content: "User Menu", classes: "col-lg-1 col-md-1"},
      ...
      {name: "applicationActionHolder", classes: "row", components: [
        ...
        {name: "contentHeader", classes: "col-lg-10 col-md-10", style: "min-height: 50px; background: #eee;"}
      ]},
      {name: "applicationContainer", classes: "row", components: [
        ...
        {name: "workspace", kind: "Scroller", classes: "col-lg-10 col-md-10",
         components: [
