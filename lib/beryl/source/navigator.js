  ...
  enyo.kind({
    ...
    components: [
      {name: "applicationHeader", classes: "row", components: [
        ...
        {content: "Search Bar", classes: "col-lg-8"},
    ...
    setContentPanel: function (index) {
      ...
      if (panelStatus === 'active') {
        ...
        if (panel instanceof XV.List) {
          ...
          // TODO: Determine if we keep pull out and code it up.
          // Bubble parameter widget up to pullout
          //this.doListAdded(panel);
        }
        ...
        // TODO: If we can't user XT.error create beryl.error();
        alert("Don't know what to do with this panel status");
      }
      ...
      if (!panel) { return; }
panel.render();
      // TODO: Figure out how to handle menu actions in the new navigator
