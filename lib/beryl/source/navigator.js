  ...
  enyo.kind({
    ...
    */
    itemTap: function (inSender, inEvent) {
      var modules = this.getModules(),
          panels = this.selectedModule.panels,
          moduleIndex,
          workspace = inEvent.originator.getWorkspace(),
      ...
      // Find the index of the module, the edit view sould have the same in edit_views
      for(var i=0;i<panels.length;i++){
        if(panels[i].toggleSelected === true) {
          moduleIndex = i;
        }
      };
      ...
      if (workspace) {
        contentPanels.destroyClientControls();
        panel = contentPanels.createComponent(module.edit_views[moduleIndex]);
        panel.render();
      }
      return true;
    },
