  ...
  enyo.kind({
    ...
    components: [
      ...
      {name: "applicationActionHolder", classes: "row", components: [
        {name: "navigationMenu", classes: "col-lg-2", components: [
          {kind: "onyx.PickerDecorator", onChange: "modulePickerChanged", components: [
            {}, // onyx.PickerButton
            {name: "modulePicker", kind: "onyx.Picker"}
          ]}
        ]},
        {name: "contentHeader", classes: "col-lg-10", style: "min-height: 50px; background: #eee;"}
      ]},
      {name: "applicationContainer", classes: "row", components: [
        ...
        {name: "workspace", kind: "Scroller", classes: "col-lg-10", components: [
