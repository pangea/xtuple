    ...
    buildSubModuleToolbar: function() {
      var panel       = this.$.contentPanels.getActive(),
          ...
          actions     = [
            ...
            {content: 'New', value: 'new', placement: 'right', name: "newButton"},
            {content: 'Export', value: 'export', placement: 'right', name: "exportButton"}
          ];
      ...
      _.chain(actions).compact().each(function (action) {
        ...
        // default buttons to left define placement: "right or menu"
