      ...
      {name: "applicationActionHolder", classes: "row", components: [
        ...
        {name: "subModuleToolbar", classes: "col-lg-10 col-md-10", components: [
          {classes: 'row', components: [
            {name: 'leftActionGroup', ontap: 'actionItemSelected', classes: 'col-lg-6 col-md-6'},
            {name: 'rightActionGroup', ontap: 'actionItemSelected', classes: 'col-lg-6 col-md-6', style: 'text-align: right'}
          ]}
        ]}
      ]},
